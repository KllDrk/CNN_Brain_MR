...
DLAlzheimerDatasetUrl = "processedDataset/DatasetAlzheimer/"
...
def AlzheimerDLCreate():
    os.chdir(f"{datasetUrl}{DLAlzheimerDatasetUrl}")
    ...
    print(os.listdir(f"{modelsUrl}ModelDL/AlzheimerModel"))

    model_version = max([int(i) for i in os.listdir(f"{modelsUrl}ModelDL/AlzheimerModel") + [0]]) + 1
    model.save(f"{modelsUrl}ModelDL/AlzheimerModel/AlzheimerModel{model_version}")
    pass


def AlzheimerDLStarter():
    AlzheimerDLCreate()
    pass